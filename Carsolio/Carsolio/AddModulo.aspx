...
<body>
    ...
    <div class="nav-bar">
         ...
         <asp:Panel ID="contenedorMod" runat="server">
              ...
              <asp:TextBox ID="txtCodigo" Class="form-control" runat="server" placeholder="Nombre Módulo" required></asp:TextBox> <br /> <br /> <br />

              <asp:Label ID="Label2" Style="padding-right: 8%;" runat="server" Text="Verificar Nombre: "></asp:Label><br /> 
              <asp:TextBox ID="txtNombre" Class="form-control" runat="server" Style="padding-right:50px;" placeholder="Nombre Módulo" required></asp:TextBox><br /> <br /> 

              <asp:Button ID="Button1" CssClass="form-control" runat="server" Text="Aceptar" style="width:100px; margin-left: 361px; " BackColor="#0066FF" BorderColor="Black" ForeColor="White" />
              </div>
         </asp:Panel>
    </div>
    </form>
