     ...
     public class Menu
     {
          ...
          public Literal navbar()
          {
              ...
              + "<ul class='nav1'>"
                   ...
                   + "<li><a href='consulta_por_nombre_marca.aspx'>Nombre y Marca</a></li>"
                   +"</ul></li>"

                   + "<li><a href='AddProducts.aspx'>Agregar Productos</a></li>"
                    + "<li><a href='Trsaccion.aspx'>Transacciones</a></li>"
                    + "<li><a href='AddModulo.aspx'>Agregar Módulo</a></li>"
                    + "<li><a href='agregar_usuario.aspx'>Agregar Usuario</a></li>"
